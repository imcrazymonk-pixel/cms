<?php
/**
 * Хелперы для inline SVG-иконок (Lucide, stroke-based, 24x24)
 * Подключается в index.php
 *
 * Совместимость: ключи сохранены из прежней версии (posts, categories, theme и т.д.),
 * добавлены новые ключи из нового layout/палитры (hexa, file-text, folder, file,
 * menu, image, palette). Сигнатура icon($name, $class = '') не изменена.
 */
...
function icon($name, $class = '') {
    ...
    $icons = [
        ...
        'categories' => '<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',
        ...
        'menus' => '<line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/>',
        ...
        'hexa' => '<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>',
    ];

    if (!isset($icons[$name])) return '';

    $classAttr = $class ? ' ' . $class : '';
    return '<span class="icon' . $classAttr . '"><svg ' . $svgAttrs . '>' . $icons[$name] . '</svg></span>';
}
